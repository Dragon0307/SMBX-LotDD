...
--breathMeter.lua - 'cause the X2 devs will shout at you if you use lsBreathMeter. Also featuring Sonic music.
...
local oxygen = 10 -- Oxygen remaining. You only get 10 at first.
