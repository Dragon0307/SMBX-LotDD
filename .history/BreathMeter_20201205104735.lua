...
function breathMeter.onTick()
	inWater = player:mem(0x34, FIELD_WORD) -- Plagiarized from LsBreathMeter. Whoever, wrote this, I owe you thanks. 0x34 = In a liquid.
	if inWater > 0 then -- If you are in water, starts the countdown.
