...
function stat.xpDrop(NPCID, reward) -- xpDrop - Adds an enemy and its experience drop to your command  Replace NPCID with the ID of the NPC in question and reward with the XP drop.
    xpDrops[NPCID] = reward
end

function stats.onNPCKill(EventObj, killedNPC, killReason) -- This raids the Lua 
