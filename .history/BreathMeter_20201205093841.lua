...
local maoxygen = 10 -- Oxygen remaining. If it reaches 0, you're toast.
local liquids = 

-- Exposed variable. This can be accessed by anything that loads the API.

breathMeter.maxOxygen = 10 -- Max oxygen. The 
breathMeter.drownRate = 2.5 -- The time it takes you lose a unit of oxygen.
breathMeter
...
breathMeter.onStart()
	oxygen = breathMeter.maxOxygen -- Sets your oxygen to the max you set.
