-- I don't know whether I'm allowed to do this, but I'm buffing somebody else's mob. --Dragon0307
		...
		if data.kamitimer > 256 then
			...
			elseif data.kamitimer >= 266 and data.kamitimer < 306 then
				...
				if data.kamitimer == 274 or data.kamitimer == 282 or data.kamitimer == 290 or data.kamitimer == 298 then
					local fire = NPC.spawn(390,v.x+8+(16*v.direction),v.y-8,player.section)
					SFX.play(18)
					fire.speedY = -7
