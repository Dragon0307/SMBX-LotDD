...
function onEvent(eventName)
    if eventName == "Toad Quest"
        ...
        if LevelSD.wheelFound == true then
            Text.showMessageBox("Wait, is that what I think it is? No, it's not my steering wheel. But, at the end of the day, it's *A* steering wheel, so I can actually drive my")
