...
local oxygen = 10 -- Oxygen remaining. It goes down every 2.5 se If it reaches 0, you're toast.

-- Exposed variable. This can be accessed by anything that loads the API.

breathMeter.maxOxygen = 10
...
breathMeter.onStart()
	oxygen = breathMeter.maxOxygen -- Sets your oxygen to the max up
end
