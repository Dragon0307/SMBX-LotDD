...
local function onStart()
    ...
    if LevelSD.larryKilled == 1 then
        layer.hide(larryLayer, true) -- Same goes with Larrus
    end

    if LevelSD.bowserKilled == 1 then
        layer.hide(boomLayer, true) -- and PRINCESS BOWZAH, who has fallen in the lava more times than even bloody Miyamoto can count.
    end
end
