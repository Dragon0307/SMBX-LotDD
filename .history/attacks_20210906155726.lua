...
attack.Mana = 0 -- MANA - This is how much power you have left to use special attacks. Don't bother changing this.
attack.maxMana = 0 -- MAX MANA - This is the MP limit. You can change this, but I would advise using fancy Lua jank to change it on the fly.
...
function attack.chillout()
    if attack.MPCheck(5) == true then
        ...
        NPC.spawn(237, player.x, player.y, player.section, false, true) --spawns an Yoshi fireball at your exact location.
