...
tweaks = requre("tweaks") -- I saw in it and thought it seemed cool, despite aparently being awful code.
...
local warpTransition = require("warpTransition") --Globalized for ease of use.
