<<<<<<< HEAD:.history/luna_20210816151728.lua
...
stats = require("Stats") -- Installs a custom library that I should not be proud of but I am.
allAchievements = Achievements.get() -- Stuffs all the achievements into a useable state.
...
local function onNPCKill(EventObj, killedNPC, killReason) -- Restore mana when collecting a ? Mushroom
    if killedNPC.id == 178 then
        attack.Mana = attack.Mana + 12
    end
end
...
>>>>>>> 9d4d6182c4ee6b3d8c8010a828eef394ffe00337:.history/luna_20201213111835.lua
