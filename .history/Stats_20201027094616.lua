...
--XP drops, this table contains your NPC ID and all that.
...
function onPostNPCKill(EventObj, killedNPC, killReason)
    if (killReason ~= HARM_TYPE_OFFSCREEN or HARM_TYPE_LAVA) and xpDrops[killedNPC.id] then
