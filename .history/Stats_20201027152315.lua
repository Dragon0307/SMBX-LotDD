...
function stat.xpDrop(NPCID, reward) -- xpDrop - Adds an enemy and its experience drop to your Replace NPCID with the ID of the NPC in question and reward with the XP drop.
