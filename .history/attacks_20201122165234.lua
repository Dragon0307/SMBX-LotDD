...
function attack.fireOrb()
    if attack.MPCheck(4) == true then
        NPC.spawn(108, player.x + xOffset, player.y + 0.5 * npcPowerup.yOffset + (player:mem(0xD0, FIELD_DFLOAT) - 53)*0.5 - 16, player.section) -- mercilessly stolen from Mega Man's code, by Horikawa
